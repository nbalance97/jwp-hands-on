...
class ReflectionTest {
    ...
    void givenObject_whenGetsFieldNamesAtRuntime_thenCorrect() {
        ...
        // getFields는 private는 읽어들이지 못함
        // getDeclaredFields는 private와 관련 없이 모두 읽어들일 수 있음.
    ...
    void givenClass_whenGetsMethods_thenCorrect() {
        ...
        // 마찬가지로 getMethods는 private는 가지고 올 수 없다.
        // 모두 가지고 오고 싶다면 getDeclaredMethods().
    ...
    void givenClass_whenGetsAllConstructors_thenCorrect() {
        ...
        // 마찬가지로 getDeclaredConstructors는 private는 가지고 올 수 없다.
        // 모두 가지고 오고 싶다면 getDeclaredConstructors().
    ...
    void givenClass_whenInstantiatesObjectsAtRuntime_thenCorrect() throws Exception {
        ...
        final Question secondQuestion = (Question) secondConstructor.newInstance(1L,
                "gugu", "제목2", "내용2", null, 10);
