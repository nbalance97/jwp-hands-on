...
class Stage1Test {
    ...
    void testJdbcConnectionPool() throws SQLException {
        final JdbcConnectionPool jdbcConnectionPool = JdbcConnectionPool.create(
                H2_URL, USER, PASSWORD
        );
    ...
    void testHikariCP() {
        ...
        hikariConfig.addDataSourceProperty("cachePrepStmts", "true"); // boolean 타입이 아닌 String 타입으로 설정해 주어야 한다.
